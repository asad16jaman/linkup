                            ...
                            <div class="col-md-6 col-12">
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <input type="text" class="form-control p-1"  name="username" value=""
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <input type="text" class="form-control p-1"  name="fullname" value=""
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <input type="email" value="" name="email" class="form-control p-1" id="" placeholder="Enter Email">
                                                ...
                                                @forelse($allUsers as $user)
                                                    <tr role="row" class="odd" >
                                                        ...
                                                        <td class="d-flex justify-content-center">
                                                            ...
                                                            <a href="" class="btn btn-info p-1 me-1">
