                            ...
                            <div class="col-md-6 col-12">
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <input type="text" class="form-control p-1"  name="title" value="{{ $editSlider ? $editSlider->title : "" }}"
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <textarea class="form-control" name="description" placeholder="" id="comment" rows="3">{{ $editSlider ? $editSlider->description : "" }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-12 d-flex justify-content-center mt-1">
                                         <label for="imageInput" style="cursor: pointer;">
                                            <!-- (placeholder) -->
                                            <img id="previewImage" 
                                                src="{{ $editSlider ? asset('storage/'.$editSlider->img) :  asset('assets/admin/img/demoProfile.png') }}" 
                                                alt="Demo Image" 
                                                class="profileImg"
                                                style="">
                                        </label>
                                            ...
                                            <table id="basic-datatables"
                                                ...
                                                @forelse($allSlider as $item)
                                                    <tr role="row" class="odd" >
                                                        ...
                                                        <td>
                                                            <img class="tablepicture" src="{{ asset('storage/'.$item->img) }}" alt="Image Not Found">
                                                        </td>
                                                        <td>{{ $item->title }}</td>
                                                        ...
                                                        <td class="d-flex justify-content-center">
                                                            ...
                                                            <a href="{{ route('admin.slider',['id'=>$item->id]) }}" class="btn btn-info p-1 me-1">
